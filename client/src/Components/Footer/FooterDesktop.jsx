...
export const FooterDesktop = () => {
  return (
    <footer className="footer 1lg:block py-8 bg-[#e5e5e5] border-t-[12px] border-t-[#187733]">
      <div className="container w-full mx-auto px-[15px]">
        <div className="footer_top flex gap-4 border-b border-b-[#b2bac6]">
          <div className="footer_top-links flex-[20%_1]">
            <p className="font-bold text-[#5e6f88] mb-5">Về Pharma Shop</p>
            <a
              title="Giới thiệu"
              target="_self"
              href="/#"
          ...
          <div className="footer_top-links flex-[20%_1]">
            <p className="font-bold text-[#5e6f88] mb-5">Danh mục</p>
            <a
              title="Dược Phẩm"
              target="_self"
              href="/#"
          ...
          <div className="footer_top-links flex-[20%_1]">
            <p className="font-bold text-[#5e6f88] mb-5">
              CSKH <span className="font-bold text-[#187733]">0866554764</span>
            </p>
          ...
          <div className="footer_top-links flex-[20%_1]">
            <p className="font-bold text-[#5e6f88] mb-5">Theo dõi tôi</p>
            <a
              title="Giới thiệu"
              target="_self"
              href="/#"
        ...
        <div className="footer_bot text-center">
          <p className="text-[#5e6f88] my-4">Công ty TNHHMTV TTNB</p>
          <p className="text-[#5e6f88] ">
